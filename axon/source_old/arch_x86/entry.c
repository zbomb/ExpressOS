...
void axk_x86_c_bsp_entry( struct tzero_payload_params_t* ptr_info )
{
    ...
    struct axk_error_t err;
    if( !axk_x86_bootparams_parse( ptr_info, &err ) )
    {
        // Inform the bootloader we failed to load
        if( ptr_info->fn_load_failed != NULL )
        {
            ptr_info->fn_load_failed( "The boot parameters couldn't be parsed!", err.message );
        }
    ...
    /*
        Initialize the 'basic out' system so we can print to the screen
    */
    if( !axk_basicout_init() )
    {
        // Inform the bootloader we failed to load
        ptr_info->fn_load_failed( "The basic output system couldnt be initialized!", NULL );
        axk_halt();
    }

    /*
        Now, we have the ability to output information, so we dont need the bootloader anymore
    */
    ptr_info->fn_load_success();
    axk_basicout_prints( "=====> Success \n" );
    axk_halt();
    ...
    */
    if( !axk_pagemgr_init() )
    {
        axk_panic( "Kernel: failed to initialize page manager" );
    }
...
bool axk_start_aux_processors( uint32_t* out_cpu_count )
{
    ...
    // Print debug message
    axk_basicout_lock();
    axk_basicout_prints( "Boot: Started all available processors, there are now " );
    axk_basicout_printu32( *out_cpu_count );
    axk_basicout_prints( " processors running\n" );
    axk_basicout_unlock();
...
bool axk_build_system_info_bsp( uint32_t cpu_count )
{
    ...
    // DEBUG
    axk_basicout_lock();
    axk_basicout_prints( "====> CPU (OSID: 0)  Domain: " );
    axk_basicout_printu32( bsp_info.domain );
    axk_basicout_prints( " CDM: " );
    axk_basicout_printu32( bsp_info.clock_domain );
    axk_basicout_prints( " Pkg: " );
    axk_basicout_printu32( bsp_info.package_id );
    axk_basicout_prints( " Core: " );
    axk_basicout_printu32( bsp_info.core_id );
    axk_basicout_prints( " SMT: " );
    axk_basicout_printu32( bsp_info.smt_id );
    axk_basicout_printnl();
    axk_basicout_printtab();
    axk_basicout_prints( " L1: " );
    axk_basicout_printu32( bsp_info.cache_l1_id );
    axk_basicout_prints( " (" );
    axk_basicout_printu32( bsp_info.cache_l1_size / 1024 );
    axk_basicout_prints( "KB) L2: " );
    axk_basicout_printu32( bsp_info.cache_l2_id );
    axk_basicout_prints( " (" );
    axk_basicout_printu32( bsp_info.cache_l2_size / 1024 );
    axk_basicout_prints( "KB) L3: " );
    axk_basicout_printu32( bsp_info.cache_l3_id );
    axk_basicout_prints( " (" );
    axk_basicout_printu32( bsp_info.cache_l3_size / 1024 );
    axk_basicout_prints( "KB)\n" );
    axk_basicout_unlock(); 
...
bool axk_build_system_info_ap( uint32_t cpu_id )
{
    ...
    // DEBUG
    axk_basicout_lock();
    axk_basicout_prints( "====> CPU (OSID: " );
    axk_basicout_printu32( ap_info.identifier );
    axk_basicout_prints( ")  Domain: " );
    axk_basicout_printu32( ap_info.domain );
    axk_basicout_prints( " CDM: " );
    axk_basicout_printu32( ap_info.clock_domain );
    axk_basicout_prints( " Pkg: " );
    axk_basicout_printu32( ap_info.package_id );
    axk_basicout_prints( " Core: " );
    axk_basicout_printu32( ap_info.core_id );
    axk_basicout_prints( " SMT: " );
    axk_basicout_printu32( ap_info.smt_id );
    axk_basicout_printnl();
    axk_basicout_printtab();
    axk_basicout_prints( " L1: " );
    axk_basicout_printu32( ap_info.cache_l1_id );
    axk_basicout_prints( " (" );
    axk_basicout_printu32( ap_info.cache_l1_size / 1024 );
    axk_basicout_prints( "KB) L2: " );
    axk_basicout_printu32( ap_info.cache_l2_id );
    axk_basicout_prints( " (" );
    axk_basicout_printu32( ap_info.cache_l2_size / 1024 );
    axk_basicout_prints( "KB) L3: " );
    axk_basicout_printu32( ap_info.cache_l3_id );
    axk_basicout_prints( " (" );
    axk_basicout_printu32( ap_info.cache_l3_size / 1024 );
    axk_basicout_prints( "KB)\n" );
    axk_basicout_unlock(); 

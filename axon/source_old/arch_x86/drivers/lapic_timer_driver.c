...
bool axk_x86_calibrate_lapic_timer( struct axk_timer_driver_t* self )
{
    ...
    if( crystal_frequency != 0UL )
    {
        ...
        if( c_diff < observed / 100UL )
        {
            ...
            axk_basicout_prints( "LAPIC Timer (x86): Acquired rate from the crystal frequency (" );
    ...
    if( bus_frequency != 0UL )
    {
        ...
        if( b_diff < observed / 100UL )
        {
            ...
            axk_basicout_prints( "LAPIC Timer (x86): Acquired rate from system bus frequency (" );
            axk_basicout_printu64( this->frequency );
            axk_basicout_prints( " Hz)\n" );
    ...
    axk_basicout_prints( "LAPIC Timer (x86): Calibrated rate, observed at " );
    axk_basicout_printu64( this->frequency );
    axk_basicout_prints( " Hz" );

    if( crystal_frequency != 0UL ) { axk_basicout_prints( " (Warning: Not equal to crystal frequency\n" ); }
    else if( bus_frequency != 0UL ) { axk_basicout_prints( " (Warning: Not equal to bus frequency\n" ); }
    else { axk_basicout_printnl(); }
...
bool lapic_timer_init( struct axk_timer_driver_t* self )
{
    ...
    axk_basicout_prints( "LAPIC Timer (x86): Initialized successfully. Constant? " );
    axk_basicout_prints( this->b_constant ? "YES" : "NO" );
    axk_basicout_prints( "  Deadline Mode? " );
    axk_basicout_prints( this->b_deadline_mode ? "YES" : "NO" );

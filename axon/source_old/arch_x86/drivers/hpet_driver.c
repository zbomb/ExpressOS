...
bool hpet_init( struct axk_timer_driver_t* self )
{
    ...
    if( ( ( config & 0b10 ) != 0UL ) )
    {
        axk_basicout_prints( "HPET (x86): Disabling legacy routing mode\n" );
    }
    ...
    {
        axk_basicout_prints( "HPET (x86): There are no timers that support periodic mode! \n" );
        return false;
    }
    ...
    axk_basicout_prints( "HPET (x86): Initialized. 64-bit? " );
    axk_basicout_prints( this->b_long_counter ? "YES" : "NO" );
    axk_basicout_prints( "  FSB Routing? " );
    axk_basicout_prints( this->b_timer_fsb ? "YES" : "NO" );
    axk_basicout_prints( "  Index: " );
    axk_basicout_printu32( this->timer_index );
    axk_basicout_prints( "  Global Int: " );
    axk_basicout_printu32( routing.global_interrupt );
    axk_basicout_prints( "  Comparator 64-bit? " );
    axk_basicout_prints( this->b_timer_long ? "YES" : "NO" );

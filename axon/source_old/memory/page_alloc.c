...
bool axk_pagemgr_init( void )
{
    ...
    // Debug message
    axk_basicout_prints( "Page Allocator: Available memory " );
    axk_basicout_printu64( ( g_total_mem / 1024UL / 1024UL ) );
    axk_basicout_prints( "MB \t(" );
    axk_basicout_printu64( g_page_count );
    axk_basicout_prints( " pages)\n" );

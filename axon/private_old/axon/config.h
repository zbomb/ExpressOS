...
#define AXK_MIN_INTERRUPT_HANDLER 64
#define AXK_INT_ERROR 0x31
#define AXK_INT_NMI 0x02
#define AXK_INT_MINIMUM 0x20
#define AXK_INT_IGNORED 0x20
#define AXK_INT_EXT_CLOCK_TICK 0x30
#define AXK_INT_INTERLINK 0x32
#else
#define AXK_MAX_INTERRUPT_HANDLERS 128
#define AXK_INT_ERROR 0x31
#define AXK_INT_NMI 0x02
...
/*
    Error Codes
*/
#define AXK_ERROR_NONE      0
#define AXK_ERROR_UNKNOWN   1

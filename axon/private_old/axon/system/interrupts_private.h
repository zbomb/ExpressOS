/*==============================================================
    Axon Kernel - Private Interrupt Managment Functions
    2021, Zachary Berry
    axon/private/axon/system/interrupts_private.h
==============================================================*/
...
struct axk_interrupt_driver_t
{
    ...
    bool( *clear_external_routing )( struct axk_interrupt_driver_t*, uint32_t );
    uint32_t( *get_available_external_routings )( struct axk_interrupt_driver_t*, uint32_t* );

...
bool axk_mapmgr_init( void )
{
    ...
    // Print debug message
    axk_terminal_prints( "Memory Map: Physical address range " );
    axk_terminal_printh64( AXK_KERNEL_VA_PHYSICAL );
    axk_terminal_prints( " to " );
    axk_terminal_printh64( AXK_KERNEL_VA_PHYSICAL + ( page_counter * 0x200000UL ) );
